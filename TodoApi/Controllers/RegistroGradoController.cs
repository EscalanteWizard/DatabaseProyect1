...
public async Task<IActionResult> Create([Bind("Atributos")]Grado grado){
    if(ModelState.IsValid){
        ...
        comando.CommandText="registro_grado";  //variable del texto del comando que se va a llamar a través de la conexión

        comando.Parameters.Add("@numero",System.Data.SqlDbType.int).Value=Grado.numero;
        comando.Parameters.Add("@descripcion",System.Data.SqlDbType.varchar,50).Value=Grado.descripcion;        
