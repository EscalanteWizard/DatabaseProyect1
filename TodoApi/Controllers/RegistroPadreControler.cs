...
public async Task<IActionResult> Create([Bind("Atributos")]Profesor profesor){
    if(ModelState.IsValid){
        ...
        comando.Parameters.Add("@nombre_c",System.Data.SqlDbType.carchar,50).Value=Padre.nombre_conyugue;
        comando.Parameters.Add("@telefono_c",System.Data.SqlDbType.int).Value=Padre.telefono_conyugue;
        comando.Parameters.Add("@profesion",System.Data.SqlDbType.carchar).Value=Padre.profesion;
